(function (t) {
  ...
  var e,
        ...
        if (g.length) {
          if (!t) {
            var e = document.getElementById(
              "skitt-listening-text__instructions"
            );
    ...
    y = function () {
      h() &&
        (c.classList.remove("skitt-ui--not-listening"),
        c.classList.add("skitt-ui--listening"));
    },
    T = function () {
      h() &&
        (c.classList.add("skitt-ui--not-listening"),
  ...
  a.SpeechKITT = {
    ...
    startRecognition: function () {
      ...
      var t;
      r &&
        ((t = new Date()).setTime(t.getTime() + 6e4 * r),
        (document.cookie =
    ...
    render: function () {
      h() ||
        ...
        p(),
        document
          .getElementById("skitt-toggle-button")
          .addEventListener("click", function () {
            a.SpeechKITT.toggleRecognition();
          })),
        -1 === document.cookie.indexOf("skittremember") ||
          this.isListening() ||
    ...
    setInstructionsText: function (t) {
      "string" == typeof t &&
        ((u = t), _(t, "skitt-listening-text__instructions"));
    },
